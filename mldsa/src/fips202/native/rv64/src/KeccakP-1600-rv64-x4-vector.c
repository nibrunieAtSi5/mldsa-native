...
void KeccakP1600_StatePermute_x4_vector(uint64_t *state)
{
    ...
    for (; avl > 0;) {
        ...
        for (round = 0; round < NROUNDS; round += 2)
        {
            ...
            // Eba = BCa ^ ((~BCe) & BCi);
            Eba = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCe), BCi, vl);
            Eba = __riscv_vxor_vv_u64m1(Eba, BCa, vl);
            // Eba ^= KeccakF_RoundConstants[round];
            Eba = __riscv_vadd_vx_u64m1(Eba, KeccakF_RoundConstants[round], vl);
            // Ebe = BCe ^ ((~BCi) & BCo);
            Ebe = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCi), BCo, vl);
            Ebe = __riscv_vxor_vv_u64m1(Ebe, BCe, vl);
            // Ebi = BCi ^ ((~BCo) & BCu);
            Ebi = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCo), BCu, vl);
            Ebi = __riscv_vxor_vv_u64m1(Ebi, BCi, vl);
            // Ebo = BCo ^ ((~BCu) & BCa);
            Ebo = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCu), BCa, vl);
            Ebo = __riscv_vxor_vv_u64m1(Ebo, BCo, vl);
            // Ebu = BCu ^ ((~BCa) & BCe);
            Ebu = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCa), BCe, vl);
            ...
            // Ega = BCa ^ ((~BCe) & BCi);
            Ega = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCe), BCi, vl);
            Ega = __riscv_vxor_vv_u64m1(Ega, BCa, vl);
            // Ege = BCe ^ ((~BCi) & BCo);
            Ege = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCi), BCo, vl);
            Ege = __riscv_vxor_vv_u64m1(Ege, BCe, vl);
            // Egi = BCi ^ ((~BCo) & BCu);
            Egi = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCo), BCu, vl);
            Egi = __riscv_vxor_vv_u64m1(Egi, BCi, vl);
            // Ego = BCo ^ ((~BCu) & BCa);
            Ego = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCu), BCa, vl);
            Ego = __riscv_vxor_vv_u64m1(Ego, BCo, vl);
            // Egu = BCu ^ ((~BCa) & BCe);
            Egu = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCa), BCe, vl);
            ...
            // Eka = BCa ^ ((~BCe) & BCi);
            Eka = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCe), BCi, vl);
            Eka = __riscv_vxor_vv_u64m1(Eka, BCa, vl);
            // Eke = BCe ^ ((~BCi) & BCo);
            Eke = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCi), BCo, vl);
            Eke = __riscv_vxor_vv_u64m1(Eke, BCe, vl);
            // Eki = BCi ^ ((~BCo) & BCu);
            Eki = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCo), BCu, vl);
            Eki = __riscv_vxor_vv_u64m1(Eki, BCi, vl);
            // Eko = BCo ^ ((~BCu) & BCa);
            Eko = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCu), BCa, vl);
            Eko = __riscv_vxor_vv_u64m1(Eko, BCo, vl);
            // Eku = BCu ^ ((~BCa) & BCe);
            Eku = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCa), BCe, vl);
            ...
            // Ema = BCa ^ ((~BCe) & BCi);
            Ema = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCe), BCi, vl);
            Ema = __riscv_vxor_vv_u64m1(Ema, BCa, vl);
            // Eme = BCe ^ ((~BCi) & BCo);
            Eme = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCi), BCo, vl);
            Eme = __riscv_vxor_vv_u64m1(Eme, BCe, vl);
            // Emi = BCi ^ ((~BCo) & BCu);
            Emi = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCo), BCu, vl);
            Emi = __riscv_vxor_vv_u64m1(Emi, BCi, vl);
            // Emo = BCo ^ ((~BCu) & BCa);
            Emo = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCu), BCa, vl);
            Emo = __riscv_vxor_vv_u64m1(Emo, BCo, vl);
            // Emu = BCu ^ ((~BCa) & BCe);
            Emu = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCa), BCe, vl);
            ...
            // Esa = BCa ^ ((~BCe) & BCi);
            Esa = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCe), BCi, vl);
            Esa = __riscv_vxor_vv_u64m1(Esa, BCa, vl);
            // Ese = BCe ^ ((~BCi) & BCo);
            Ese = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCi), BCo, vl);
            Ese = __riscv_vxor_vv_u64m1(Ese, BCe, vl);
            // Esi = BCi ^ ((~BCo) & BCu);
            Esi = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCo), BCu, vl);
            Esi = __riscv_vxor_vv_u64m1(Esi, BCi, vl);
            // Eso = BCo ^ ((~BCu) & BCa);
            Eso = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCu), BCa, vl);
            Eso = __riscv_vxor_vv_u64m1(Eso, BCo, vl);
            // Esu = BCu ^ ((~BCa) & BCe);
            Esu = __riscv_vand_vv_u64m1(__riscv_vnot_v_u64m1(BCa), BCe, vl);
